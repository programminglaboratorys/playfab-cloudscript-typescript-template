...
var HelloWorldDefault = function (
  args: any,
  context: IPlayFabContext
): IHelloWorldResponse {
...
var HandlePlayStreamEventAndProfile = function (
  args: any,
  context: IPlayFabContext
): IHandlePlayStreamEventAndProfileResponse {
...
var UnlockHighSkillContent = function (
  args: any,
  context: IPlayFabContext
): IUnlockHighSkillContentResponse {
  var playerStatUpdatedEvent =
    context.playStreamEvent as PlayStreamModels.player_statistic_changed;
...
var RoomEventRaised = function (args): void {
  ...
  log.debug(
    "Event Raised - Game: " + args.GameId + " Event Type: " + eventData.eventType
  );
